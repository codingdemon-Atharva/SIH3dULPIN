  ...
  return (
    <div className="p-6 sm:p-8 space-y-8 max-w-7xl mx-auto">
      <GovernmentPageHeader
        title="GIS & Topological Validation"
        description="Automated 3D overlap checks, topological consistency, and boundary validation."
      />
      ...
      <div className="rounded-2xl border border-[#e2dad0] bg-white p-8 text-center space-y-4 shadow-sm">
        ...
        <h2 className="text-lg font-extrabold text-[#162a21]">
          GIS Validation Module
        </h2>
        <p className="text-xs text-[#6b887a] max-w-md mx-auto leading-relaxed">
          Full Government GIS/Data Validation management features will be active in Phase 18. Verified parcel status can be checked in the Government Dashboard Overview.
        </p>
        <div className="pt-2">
          <Link
