  ...
  return (
    <div className="p-6 sm:p-8 space-y-8 max-w-7xl mx-auto">
      <GovernmentPageHeader
        ...
        description="Official national land administration reports, state summaries, and audit logs."
      />
      ...
      <div className="rounded-2xl border border-[#e2dad0] bg-white p-8 text-center space-y-4 shadow-sm">
        ...
        <h2 className="text-lg font-extrabold text-[#162a21]">
          Government Reports Module
        </h2>
        <p className="text-xs text-[#6b887a] max-w-md mx-auto leading-relaxed">
          Full Government Analytics & Reports features will be active in Phase 19. High-level KPI summary cards are available in the Government Dashboard Overview.
        </p>
        <div className="pt-2">
          <Link
